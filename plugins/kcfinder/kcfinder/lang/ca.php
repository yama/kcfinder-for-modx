...
$lang = array(
    ...
    "Cannot move uploaded file to target folder." => "No es pot moure el fitxer pujat al directori desti",
    "Unknown error." => "Error desconegut.",
    "The uploaded file exceeds {size} bytes." => "El fitxer seleccionat excedeix el pes maxim permes ( {size} bytes ).",
    "The uploaded file was only partially uploaded." => "El fitxer seleccionat nomes s'ha carregat parcialment.",
    "No file was uploaded." => "No s'ha carregat cap fitxer.",
    "Missing a temporary folder." => "Manca un directori temporal.",
    "Failed to write file." => "No s'ha pogut escriure el fitxer.",
    "Denied file extension." => "Extensio de fitxer no permesa.",
    "Unknown image format/encoding." => "Format d'imatge desconegut.",
    "The image is too big and/or cannot be resized." => "La imatge es massa gran i/o no es pot redimensionar.",
    "Cannot create {dir} folder." => "No s'ha pogut crear el directori {dir}",
    "Cannot rename the folder." => "No es pot reanomenar el directori.",
    "Cannot write to upload folder." => "No es pot escriure al directori de carrega de fitxers.",
    ...
    "Cannot read upload folder." => "No s'ha pogut llegir la carpeta de carrega de fitxers.",
    "Cannot access or create thumbnails folder." => "No s'ha pogut accedir o crear la carpeta de miniatures.",
    "Cannot access or write to upload folder." => "No s'ha pogut accedir o escriure la carpeta de carrega de fitxers.",
    "Please enter new folder name." => "Si us plau, introduiu el nom del nou directori.",
    "Unallowable characters in folder name." => "Caracters no permesos en el nom del directori.",
    "Folder name shouldn't begins with '.'" => "El nom d'un directori no hauria de comencar amb un punt '.'",
    "Please enter new file name." => "Si us plau, introduiu el nom del nou fitxer.",
    "Unallowable characters in file name." => "Caracters no permesos en el nom del fitxer.",
    "File name shouldn't begins with '.'" => "El nom d'un fitxer no hauria de comencar amb un punt '.'",
    ...
    "Fileinfo PECL extension is missing." => "Manca arxiu d'informacio de l'extensio PECL.",
    "Opening fileinfo database failed." => "Error obrint el fitxer d'informacio de la base de dades.",
    ...
    "Copy files here" => "Copia els fitxers aqui",
    "Move files here" => "Mou els fitxers aqui",
    ...
    "Copy {count} files" => "Copia els {count} fitxers aqui",
    "Move {count} files" => "Mou els {count} fitxers aqui",
    ...
    "Download version {version} now!" => "Descarregueu la versio {version}!",
    "KCFinder is up to date!" => "KCFinder esta actualitzat!",
    "Licenses:" => "Llicencies:",
    "Attention" => "Atencio",
    "Question" => "Pregunta",
    "Yes" => "Si",
    "No" => "No",
    "You cannot rename the extension of files!" => "No esta permes canviar la extensio al fitxer.",
