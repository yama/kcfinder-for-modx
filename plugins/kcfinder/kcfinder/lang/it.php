...
$lang = array(
    ...
    "The uploaded file was only partially uploaded." => "Il file ﾃｨ stato caricato parzialmente.",
    "No file was uploaded." => "Nessun file ﾃｨ stato caricato",
    ...
    "Unknown image format/encoding." => "Il format/encoding dell'immagine ﾃｨ sconosciuto.",
    "The image is too big and/or cannot be resized." => "L'immagine ﾃｨ troppo grande e/o non puﾃｲ essere rimpicciolita",
    "Cannot create {dir} folder." => "La cartella {dir} non puﾃｲ essere creata.",
    "Cannot rename the folder." => "Non ﾃｨ possibile rinominare la cartella.",
    ...
    "Incorrect .htaccess file. Cannot rewrite it!" => "Il file .htaccess ﾃｨ corrotto. Impossibile riscriverlo!",
    ...
    "Folder name shouldn't begins with '.'" => "Il nome della cartella non puﾃｲ iniziare con'.'",
    ...
    "File name shouldn't begins with '.'" => "Il nome del file non puﾃｲ iniziare con '.'",
    ...
    "You can't upload such files." => "Non ﾃｨ possibile caricare questi files.",
    ...
    "Cannot delete the folder." => "Non ﾃｨ possibile cancellare la cartella.",
    "Click to remove from the Clipboard" => "Click per rimuoverlo dalla Clipboard",
    "This file is already added to the Clipboard." => "Questo file ﾃｨ giﾃ stato aggiunto alla Clipboard.",
    ...
    "The selected files are not removable." => "Il file selezionato non ﾃｨ rimovibile.",
    ...
    "A file or folder with that name already exists." => "Un file o cartella con questo nome giﾃ esiste.",
    ...
    "Inexistant or inaccessible folder." => "La cartella non esiste o ﾃｨ inacessibile.",
    ...
    "KCFinder is up to date!" => "KCFinder ﾃｨ aggiornato!",
    "Licenses:" => "Licenze:",
    ...
    "Failed to upload {filename}!" => "Il caricamento del file {filename} ﾃｨ fallito ",
);
